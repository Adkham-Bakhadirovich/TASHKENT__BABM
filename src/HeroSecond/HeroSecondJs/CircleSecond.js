...
import '../../HeroSecond/HeroSecondCss/CircleSecond.css'
export default function CircleSecond() {
  return (
    <div className='circle'>
      <div className='container'>
       ...
       <ul className='circle_list circle_list_second'>
        <li className='circle_list_item_extra'>
        ...
        <li className='circle_list_item graduation_second'>
